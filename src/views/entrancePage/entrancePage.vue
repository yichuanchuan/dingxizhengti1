...
.entrancePage {
  ...
  .devopsBigScreen {
    ...
    .jishi {
      ...
      top: 1288px;
      left: 961px;
      background: url('./images/jishi.png');
    }
    .yimianqiang {
      width: 1090px;
      height: 220px;
      ...
      top: 994px;
      left: 1375px;
      background: url('./images/yimianqiang.png');
    }
    .yidaoliang {
      width: 859px;
      height: 96px;
      ...
      top: 412px;
      left: 1491px;
      background: url('./images/yidaoliang.png');
    }
    .yishuguang {
      width: 566px;
      height: 234px;
      ...
      top: 542px;
      left: 1644px;
      background: url('./images/yishuguang.png');
    }
    .yishanchuang {
      width: 419px;
      height: 346px;
      ...
      top: 854px;
      left: 721px;
      background: url('./images/yishanchuang.png');
    }
    .yishanchuang2 {
      width: 404px;
      height: 350px;
      ...
      top: 871px;
      left: 2724px;
      background: url('./images/yishanchuang2.png');
    }
  }
}
</style>
